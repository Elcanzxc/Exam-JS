    ...
    getSortedTasks(tasks, sortBy) {
        ...
        if (sortBy === 'date') {
            ...
            return tasksCopy.sort((a, b) => 
                ...
                a.getTitle().localeCompare(b.getTitle(), 'ru', { sensitivity: 'base' })
            );
        }
    ...
    if (addTaskForm) {
        addTaskForm.addEventListener('submit', (e) => {
            ...
            if (!Validator.validateTitle(title)) {
                if (titleError) titleError.textContent = 'Название некорректно';
                isValid = false;
            }

            if (!Validator.validateDescription(description, title)) {
                if (descriptionError) descriptionError.textContent = 'Описание некорректно';
                isValid = false;
            }
